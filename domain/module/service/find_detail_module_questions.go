...
type FindDetailModuleQuestionsCommand struct {
	Slug string `form:"slug"`
}

type FindDetailModuleQuestions struct {
...
func NewFindDetailModuleQuestions(
	authStorage interfaces.AuthenticatedUser,
	moduleReader repository.ModuleReader,
	subjectACL repository.SubjectACL,
	gradeACL repository.GradeACL,
) *FindDetailModuleQuestions {
	return &FindDetailModuleQuestions{
...
func (s *FindDetailModuleQuestions) Execute(ctx context.Context, command *FindDetailModuleQuestionsCommand) (*response.ModuleDetail, error) {
